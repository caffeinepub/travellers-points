...
function PackageCard({ pkg, index: index2 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-40 h-40 rounded-full overflow-hidden border-4 border-gold/30 shadow-lg mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: pkg.image,
            alt: pkg.name,
...
function PackagesSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "packages", className: "py-20 bg-orange-500", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
