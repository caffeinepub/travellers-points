    ...
    itinerary: [
      {
        ...
        details: "Check-in hotel. Evening local sightseeing: Zangto Pelri Lhakhang, Crocodile Breeding Centre, Market area."
      },
      {
        day: "Day 2",
        title: "Phuentsholing to Thimphu (165km, 5–6hrs)",
        details: "Visit Chuzom confluence, Buddha Dordenma statue, National Memorial Chorten, Tashichho Dzong."
      },
      {
        day: "Day 3",
        title: "Thimphu to Punakha (77km, 3hrs)",
        details: "Dochu La Pass (108 chortens), Punakha Dzong, Suspension Bridge, Chimi Lhakhang (Fertility Temple)."
      },
      {
        day: "Day 4",
        title: "Punakha to Paro (125km, 4hrs)",
        details: "National Museum of Bhutan, Rinpung Dzong, Paro town sightseeing."
      },
      {
        day: "Day 5",
        title: "Paro — Tiger's Nest",
        details: "Tiger's Nest Monastery (Taktshang) hike (3–4hrs). Visit Kyichu Lhakhang temple."
      },
      {
        day: "Day 6",
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        details: "Swayambhunath (Monkey Temple), Patan Durbar Square, Patan Museum."
      },
      {
        day: "Day 3",
      ...
      },
      {
        ...
        details: "Sarangkot sunrise, World Peace Pagoda, Devi's Fall, Gupteshwor Cave."
      },
      {
        day: "Day 5",
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        details: "Naggar Castle, Nicholas Roerich Art Gallery, Old Manali market."
      },
      {
        day: "Day 5",
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        details: "Fun World, Himalayan Wildlife Zoo, Indira Tourist Park, horse riding."
      },
      {
        day: "Day 3",
        title: "Local Sightseeing",
        details: "Jakhoo Temple, Summer Hill, Prospect Hill, Chadwick Falls, Glen Forest."
      },
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        details: "Mughal Gardens (Nishat, Shalimar), Shankaracharya Temple, Hazratbal Shrine."
      },
      {
        day: "Day 5",
        title: "Sonamarg",
    ...
    itinerary: [
      {
        ...
        details: "Krishna Janmabhoomi Temple, Dwarkadhish Temple, Vishram Ghat (evening aarti)."
      },
      {
        day: "Day 2",
        title: "Vrindavan",
...
function Navbar({ scrolled }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-charcoal/95 backdrop-blur-md shadow-luxury border-b border-gold/10" : "bg-gradient-to-b from-black/70 to-transparent"}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg font-semibold text-gold hidden sm:block", children: "Travellers Points" })
              ]
            }
          ),
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-charcoal border-t border-gold/10 py-4", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: l.href,
    ...
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-20 text-center px-4 max-w-5xl mx-auto", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl md:text-2xl text-cream italic mb-3", children: "From your dream to the world." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark text-sm md:text-base tracking-widest mb-10", children: "Expert tours to Bhutan • Darjeeling • Sikkim • Nepal • Kashmir" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: "#packages",
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Arrival at Phuentsholing",
        details: "Arrive at Phuentsholing (Bhutan border town). Check-in hotel. Evening local sightseeing: Zangto Pelri Lhakhang, Crocodile Breeding Centre, Market area."
      },
      {
        day: "Day 2",
        title: "Phuentsholing to Thimphu (165km, 5–6hrs)",
        details: "Proceed to Thimphu, Bhutan's capital. Visit Chuzom confluence, Buddha Dordenma statue, National Memorial Chorten, Tashichho Dzong. Overnight Thimphu."
      },
      {
        day: "Day 3",
        title: "Thimphu to Punakha (77km, 3hrs)",
        details: "Cross Dochu La Pass (108 chortens, Himalayan views). Visit Punakha Dzong, Suspension Bridge, Chimi Lhakhang (Fertility Temple). Overnight Punakha."
      },
      {
        day: "Day 4",
        title: "Punakha to Paro (125km, 4hrs)",
        details: "Drive to Paro. Visit National Museum of Bhutan, Rinpung Dzong, Paro town sightseeing. Overnight Paro."
      },
      {
        day: "Day 5",
        title: "Paro Departure",
        details: "Morning at leisure. Drop to Bagdogra Airport or NJP Railway Station. Tour ends with sweet memories of Bhutan."
      }
    ]
  },
  {
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Arrival at Phuentsholing",
        details: "Arrive at Phuentsholing. Check-in hotel. Evening local sightseeing: Zangto Pelri Lhakhang, Crocodile Breeding Centre, Market area."
      },
      {
        day: "Day 2",
        title: "Phuentsholing to Thimphu (165km, 5–6hrs)",
        details: "Drive to Thimphu via Chuzom confluence. Visit Buddha Dordenma statue, National Memorial Chorten, Tashichho Dzong. Overnight Thimphu."
      },
      {
        day: "Day 3",
        title: "Thimphu to Punakha (77km, 3hrs)",
        details: "Cross Dochu La Pass. Visit Punakha Dzong, Suspension Bridge, Chimi Lhakhang. Overnight Punakha."
      },
      {
        day: "Day 4",
        title: "Punakha to Paro (125km, 4hrs)",
        details: "Drive to Paro. Visit National Museum, Rinpung Dzong, Paro town. Overnight Paro."
      },
      {
        day: "Day 5",
        title: "Paro — Tiger's Nest Hike",
        details: "Full day Tiger's Nest Monastery (Taktshang) hike (3–4hrs, 900m ascent). Visit Kyichu Lhakhang temple. Overnight Paro."
      },
      {
        day: "Day 6",
        title: "Departure",
        details: "Morning at leisure. Drop to Bagdogra Airport or NJP Railway Station. Tour ends."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        day: "Day 2",
        title: "Phuentsholing to Thimphu (165km, 5–6hrs)",
        details: "Drive to Thimphu. Visit Chuzom confluence, Buddha Dordenma statue, National Memorial Chorten, Tashichho Dzong. Overnight Thimphu."
      },
      {
        day: "Day 3",
        title: "Thimphu — Dochula Pass & Punakha",
        details: "Morning city tour: Folk Heritage Museum, Textile Museum, Motithang Takin Preserve. Cross Dochu La Pass (3,100m). Punakha Dzong, Suspension Bridge. Overnight Punakha."
      },
      {
        day: "Day 4",
        title: "Wangdue Phodrang Exploration",
        details: "Visit Wangdue Phodrang Dzong (restored 17th-century fortress), Gangtey Gonpa (Black-necked Crane Sanctuary), Phobjikha Valley scenic drive. Overnight Punakha/Wangdue."
      },
      {
        day: "Day 5",
        title: "Punakha to Paro (125km, 4hrs)",
      ...
      },
      {
        day: "Day 6",
        title: "Paro — Tiger's Nest Hike",
        details: "Full day Tiger's Nest Monastery (Taktshang) hike (3–4hrs). Visit Kyichu Lhakhang temple. Overnight Paro."
      },
      {
        day: "Day 7",
        title: "Paro Local Sightseeing",
        details: "Visit Drukgyal Dzong (ruins of ancient fortress), Chelela Pass (highest motorable road, 3,810m), Bondey Village. Evening leisure in Paro market. Overnight Phuentsholing."
      },
      {
        day: "Day 8",
        title: "Departure",
        details: "Drop to Bagdogra Airport or NJP Railway Station. Tour ends with unforgettable Bhutan memories."
      }
    ]
  }
];
function BhutanSubPackageCard({ pkg, index: index2 }) {
  const [open, setOpen] = reactExports.useState(false);
  const waMsg = encodeURIComponent(
    `Hi, I am interested in the ${pkg.name} (${pkg.duration}). Please share details and pricing.`
  );
  const waLink2 = `https://wa.me/917719264029?text=${waMsg}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "bg-charcoal-light rounded-sm overflow-hidden shadow-card border border-gold/10 flex flex-col",
      "data-ocid": `bhutan.item.${index2 + 1}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-40 overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-charcoal/80 to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-2 left-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body text-cream-dark bg-black/60 px-2 py-0.5 rounded-sm", children: pkg.duration }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(135deg, oklch(0.62 0.13 82 / 0.15), oklch(0.75 0.13 82 / 0.05))"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-base text-gold font-semibold", children: pkg.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark text-xs mt-0.5", children: pkg.duration })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 space-y-1.5 flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold text-xs", children: "💰" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-cream font-semibold text-sm", children: pkg.price })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold text-xs mt-0.5", children: "📍" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-cream-dark text-xs", children: pkg.pickup })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold text-xs italic", children: "Customized package available on request" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            "data-ocid": `bhutan.toggle.${index2 + 1}`,
            children: [
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-4 space-y-2.5 border-t border-gold/10 pt-3", children: [
          pkg.itinerary.map((day) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block bg-gold text-charcoal text-xs font-body font-semibold px-2 py-0.5 rounded-sm", children: day.day }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream text-xs font-medium", children: day.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark text-xs mt-0.5 leading-relaxed", children: day.details })
            ] })
          ] }, day.day)),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 p-2.5 bg-charcoal/50 rounded-sm border border-gold/10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold text-xs font-semibold uppercase tracking-wider mb-1.5", children: "Inclusions" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-4 pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: waLink2,
            target: "_blank",
            ...
            "data-ocid": `bhutan.primary_button.${index2 + 1}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "svg",
                {
    ...
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display text-2xl text-gold text-center", children: "Bhutan Tour Packages" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark text-sm text-center mt-1", children: "Choose from our curated Bhutan experiences — from quick getaways to immersive journeys" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-5 mt-2", children: BHUTAN_PACKAGES.map((pkg, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(BhutanSubPackageCard, { pkg, index: i }, pkg.id)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-4 pt-4 border-t border-gold/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-cream-dark text-xs", children: [
          "All packages include Bhutan entry permits, SDF fee, accommodation, meals & guided sightseeing.",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
...
function PackageCard({ pkg, index: index2 }) {
  const [open, setOpen] = reactExports.useState(false);
  const [bhutanModalOpen, setBhutanModalOpen] = reactExports.useState(false);
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-48 overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-charcoal/80 to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-3 left-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body text-cream-dark bg-black/50 px-2 py-1 rounded-sm", children: pkg.duration }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark text-sm mt-0.5", children: pkg.duration })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4 space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-cream font-semibold", children: pkg.price })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold text-sm mt-0.5", children: "📍" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-cream-dark text-sm", children: pkg.pickup })
          ] }),
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pb-5 space-y-3 border-t border-gold/10 pt-4", children: [
          pkg.itinerary.map((day) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block bg-gold text-charcoal text-xs font-body font-semibold px-2 py-0.5 rounded-sm", children: day.day }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream text-sm font-medium", children: day.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark text-xs mt-0.5 leading-relaxed", children: day.details })
            ] })
          ] }, day.day)),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 p-3 bg-charcoal/50 rounded-sm border border-gold/10", children: [
        ...
        isBhutan && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pb-5 pt-2 border-t border-gold/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              "data-ocid": `packages.open_modal_button.${index2 + 1}`,
              children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "packages", className: "py-20 relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl text-cream mb-4", children: "Our Tour Packages" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: PACKAGES.map((pkg, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(PackageCard, { pkg, index: i }, pkg.id)) })
    ] })
  ] });
}
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark text-sm", children: service.description }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: setOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      DialogContent,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark leading-relaxed text-sm", children: service.detail }),
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl text-cream mb-4", children: "Our Services" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider" })
        ] }),
...
function TaxiSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "taxi", className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold tracking-[0.25em] text-sm uppercase mb-3", children: "Transportation" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl text-cream mb-4", children: "Local Taxi Services" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark mt-4 text-sm", children: "Reliable taxi services from Jaigaon to key destinations" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-10", children: TAXI_ROUTES.map((route) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-cream font-medium text-sm", children: [
              route.from,
              " → ",
              route.to
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold text-xs mt-1", children: "Contact for pricing" })
          ] })
        ]
      },
      route.to
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl text-cream mb-4", children: "What Our Travellers Say" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: REVIEWS.map((review, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-cream-dark text-sm leading-relaxed italic mb-5", children: [
                "“",
                review.text,
                "”"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 pt-4 border-t border-gold/10", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream text-sm font-medium", children: review.author }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark text-xs", children: review.location })
                ] })
              ] })
            ]
          },
...
function ContactSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl text-cream mb-4", children: "Contact Us" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark mt-4 text-sm", children: "Contact us to plan your dream tour" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl text-gold mb-6", children: "Travellers Points" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark text-sm leading-relaxed", children: "Your trusted travel partner for unforgettable journeys to Bhutan, Darjeeling, Sikkim, Nepal, Manali, Shimla, Kashmir, and Mathura. From your dream to the world." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream text-sm mt-0.5", children: item.value })
          ] })
        ] }, item.label)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-10 mb-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg text-gold", children: "Travellers Points" })
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark/90 text-xs mt-3 leading-relaxed", children: "Expert travel agency specializing in tours to Bhutan, Darjeeling, Sikkim, Nepal, Manali, Shimla, Kashmir, and Mathura." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground font-body", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TaxiSection, {}),
