    ...
    itinerary: [
      {
        ...
        details: "Pickup from Bagdogra Airport or NJP Station → drive to Phuentsholing. Check-in, local sightseeing: Zangto Pelri Lhakhang, Karbandi Monastery. Overnight stay."
      },
      {
        day: "Day 2",
        title: "Phuentsholing → Thimphu",
        details: "Drive to Thimphu (capital city). Visit Buddha Dordenma Statue, Takin Preserve, Memorial Chorten, Changangkha Lhakhang, Folk Heritage Museum. Overnight stay in Thimphu."
      },
      {
        day: "Day 3",
        title: "Thimphu Sightseeing",
        details: "Visit Dochula Pass (108 chortens & Himalayan views), National Museum, Tashichho Dzong, Simply Bhutan Museum. Evening: local market. Overnight stay in Thimphu."
      },
      {
        day: "Day 4",
        title: "Thimphu → Punakha",
        details: "Drive to Punakha valley. Visit Punakha Dzong (historical fortress), Chimi Lhakhang Fertility Temple, Suspension Bridge, Mo Chhu River. Overnight stay in Punakha."
      },
      {
        day: "Day 5",
        title: "Punakha → Paro",
        details: "Drive to Paro. Visit Rinpung Dzong, National Museum of Paro, Paro Town Market. Evening stroll along Paro Chhu river. Overnight stay in Paro."
      },
      {
        day: "Day 6",
        title: "Tiger's Nest Hike",
        details: "Early morning hike to Taktsang Palphug Monastery (Tiger's Nest) – one of Bhutan's most iconic sites. Also visit Drukgyel Dzong ruins, Kyichu Lhakhang. Overnight stay in Paro."
      },
      {
        day: "Day 7",
        title: "Paro → Drop",
        details: "After breakfast, drive back to the border. Drop at Bagdogra Airport or NJP Station. Tour ends with wonderful memories."
      }
    ]
  },
  {
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Pickup → Phuentsholing",
        details: "Private pickup from Bagdogra Airport or NJP Station → drive to Phuentsholing. Check-in, local sightseeing: Zangto Pelri Lhakhang, Karbandi Monastery. Overnight stay."
      },
      {
        day: "Day 2",
        title: "Phuentsholing → Thimphu",
        details: "Private drive to Thimphu. Visit Buddha Dordenma Statue, Takin Preserve, Memorial Chorten, Changangkha Lhakhang, Folk Heritage Museum. Overnight stay in Thimphu."
      },
      {
        day: "Day 3",
        title: "Thimphu Sightseeing",
        details: "Visit Dochula Pass (108 chortens), National Museum, Tashichho Dzong, Simply Bhutan Museum. Flexible itinerary as per your schedule. Overnight stay in Thimphu."
      },
      {
        day: "Day 4",
        title: "Thimphu → Punakha",
        details: "Private drive to Punakha. Visit Punakha Dzong, Chimi Lhakhang Fertility Temple, Suspension Bridge, Mo Chhu River. Overnight stay in Punakha."
      },
      {
        day: "Day 5",
        title: "Punakha → Paro",
        details: "Private drive to Paro. Visit Rinpung Dzong, National Museum, Paro Town Market. Overnight stay in Paro."
      },
      {
        day: "Day 6",
        title: "Tiger's Nest Hike",
        details: "Hike to Taktsang Palphug Monastery (Tiger's Nest). Visit Drukgyel Dzong ruins, Kyichu Lhakhang. Personalized pace. Overnight stay in Paro."
      },
      {
        day: "Day 7",
        title: "Paro → Drop",
        details: "After breakfast, private vehicle drop at Bagdogra Airport or NJP Station. Tour concludes with exceptional memories."
      }
    ]
  },
  {
    ...
    itinerary: [
      {
        ...
        details: "Pickup from NJP Station or Bagdogra Airport. Drive to Darjeeling through scenic mountain roads. Check-in and evening leisure. Overnight stay."
      },
      {
        day: "Day 2",
        title: "Tiger Hill & Monasteries",
        details: "Early morning (4am) visit to Tiger Hill for stunning Kanchenjunga & Everest sunrise. Visit Batasia Loop, Ghoom Monastery (oldest in Darjeeling), Peace Pagoda. Overnight stay."
      },
      {
        day: "Day 3",
        title: "Tea Gardens & Attractions",
        details: "Visit Happy Valley Tea Estate, Himalayan Mountaineering Institute, Padmaja Naidu Zoological Park, Ropeway ride for aerial views. Overnight stay."
      },
      {
        day: "Day 4",
        title: "Rock Garden & Shopping",
        details: "Visit Rock Garden (beautiful waterfalls & rock formations), Ganga Maya Park, Chowrasta Mall Road. Local market shopping. Overnight stay."
      },
      {
        day: "Day 5",
        title: "Departure",
        details: "After breakfast, checkout and drive back to NJP Station or Bagdogra Airport. Tour ends."
      }
    ]
  },
  {
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "NJP → Gangtok",
        details: "Pickup from NJP Station or Bagdogra Airport. Drive to Gangtok, the capital of Sikkim. Check-in and evening visit to MG Marg. Overnight stay."
      },
      {
        day: "Day 2",
        title: "Tsomgo & Nathula",
        details: "Visit Tsomgo Lake (glacial lake at 12,400 ft), Baba Mandir (soldier shrine), Nathula Pass (India-China border, permit required). Overnight stay in Gangtok."
      },
      {
        day: "Day 3",
        title: "Gangtok Monasteries",
        details: "Visit Rumtek Monastery (largest in Sikkim), Enchey Monastery, Do-Drul Chorten stupa. Evening: Lal Bazaar shopping. Overnight stay."
      },
      {
        day: "Day 4",
        title: "Gangtok → Pelling",
        details: "Drive to Pelling. Visit Rabdentse Ruins (ancient Sikkim capital), Pemayangtse Monastery (one of the oldest in Sikkim). Overnight stay in Pelling."
      },
      {
        day: "Day 5",
        title: "Khecheopalri & Singshore",
        details: "Visit Khecheopalri Lake (sacred wish-fulfilling lake), Singshore Bridge (highest bridge in Sikkim, 98m). Overnight stay in Pelling."
      },
      {
        day: "Day 6",
        title: "Pelling → NJP",
        details: "After breakfast, drive back to NJP Station or Bagdogra Airport. Tour concludes."
      }
    ]
  },
  {
    ...
    itinerary: [
      {
        ...
        details: "Arrival at Kathmandu. Transfer to hotel. Evening visit to Thamel market. Welcome dinner. Overnight stay."
      },
      {
        day: "Day 2",
        title: "Kathmandu Temples",
        details: "Visit Pashupatinath Temple (sacred Hindu temple on Bagmati River), Boudhanath Stupa (largest stupa in Asia), Swayambhunath aka Monkey Temple. Overnight stay."
      },
      {
        day: "Day 3",
        title: "Durbar Squares",
        details: "Visit Patan Durbar Square (UNESCO World Heritage Site with ancient palaces), Bhaktapur Durbar Square (medieval city of devotees). Overnight stay in Kathmandu."
      },
      {
        day: "Day 4",
        title: "Kathmandu → Pokhara",
        details: "Drive or fly to Pokhara (7 hours by road). Arrive and visit Fewa Lake (boating optional), Davis Falls, Gupteshwor Cave. Overnight stay in Pokhara."
      },
      {
        day: "Day 5",
        title: "Pokhara Sightseeing",
        details: "Early morning Sarangkot sunrise viewpoint (Annapurna range). Phewa Lake boating, World Peace Pagoda (Japanese pagoda). Evening in Lakeside market. Overnight stay."
      },
      {
        day: "Day 6",
        title: "Departure",
        details: "Morning leisure. Transfer to airport or bus station for return journey. Tour ends."
      }
    ]
  },
  {
    ...
    itinerary: [
      {
        ...
        details: "Overnight journey from Delhi or Chandigarh to Manali by Volvo bus or private vehicle. Arrive and check-in. Evening rest."
      },
      {
        day: "Day 2",
        title: "Rohtang Pass & Solang Valley",
        details: "Early morning excursion to Rohtang Pass (13,050 ft) – snow activities, paragliding. Visit Solang Valley for skiing/zorbing. Overnight stay."
      },
      {
        day: "Day 3",
        title: "Manali Local Sightseeing",
        details: "Visit Hadimba Temple (iconic wooden temple), Manu Temple, Old Manali village, Club House (river-side activities), Vashisht Hot Springs. Overnight stay."
      },
      {
        day: "Day 4",
        title: "Naggar & Bijli Mahadev",
        details: "Visit Naggar Castle (heritage hotel & museum), Roerich Art Gallery (famous Russian painter's home), Bijli Mahadev Temple (sacred high-altitude temple, 2-km trek). Overnight stay."
      },
      {
        day: "Day 5",
        title: "Adventure & Shopping",
        details: "River rafting on Beas River, local handicraft shopping, Mall Road Manali. Farewell dinner. Overnight stay."
      },
      {
        day: "Day 6",
        title: "Departure",
        details: "After breakfast, departure from Manali. Drive back to Delhi or Chandigarh. Tour ends."
      }
    ]
  },
  {
    ...
    itinerary: [
      {
        ...
        details: "Depart from Delhi or Chandigarh. Arrive Shimla, check-in. Evening walk on Mall Road. Overnight stay."
      },
      {
        day: "Day 2",
        title: "Kufri & Chail",
        details: "Day trip to Kufri (snow activities, Himalayan wildlife park), Fagu viewpoint, Green Valley, Chail (world's highest cricket ground). Overnight stay in Shimla."
      },
      {
        day: "Day 3",
        title: "Shimla City Tour",
        details: "Visit The Ridge (open air space with Himalayan panorama), Mall Road shopping, Christ Church (neo-Gothic architecture), Jakhu Temple (ancient Hanuman temple, 2.5 km trek). Overnight stay."
      },
      {
        day: "Day 4",
        title: "Mashobra & Tattapani",
        details: "Visit Mashobra village (apple orchards), Naldehra Golf Course (one of the oldest in India), Tattapani (hot sulphur springs). Overnight stay."
      },
      {
        day: "Day 5",
        title: "Departure",
        details: "After breakfast, checkout. Drive back to Delhi or Chandigarh. Tour concludes."
      }
    ]
  },
  {
    ...
    itinerary: [
      {
        ...
        details: "Arrival at Srinagar Airport. Transfer to houseboat on Dal Lake. Evening Shikara ride on Dal Lake. Overnight stay on houseboat."
      },
      {
        day: "Day 2",
        title: "Gulmarg",
        details: "Day excursion to Gulmarg (Meadow of Flowers). Gondola ride (Phase 1 & 2) up to 14,000 ft. Snow activities, skiing. Return to Srinagar. Overnight stay."
      },
      {
        day: "Day 3",
        title: "Pahalgam",
        details: "Day trip to Pahalgam (Valley of Shepherds). Visit Betaab Valley (Bollywood filming location), Chandanwari, Aru Valley. River-side picnic. Return to Srinagar. Overnight stay."
      },
      {
        day: "Day 4",
        title: "Srinagar Local",
        details: "Visit Shankaracharya Temple (hilltop Hindu shrine), Mughal Gardens (Nishat, Shalimar, Chashme Shahi), local market for Pashmina shawls & dry fruits. Overnight stay."
      },
      {
        day: "Day 5",
        title: "Sonmarg",
        details: "Day excursion to Sonmarg (Meadow of Gold). Visit Thajiwas Glacier (accessible by pony/trek). Panoramic Himalayan views. Return to Srinagar. Overnight stay."
      },
      {
        day: "Day 6",
        title: "Srinagar → Jammu",
        details: "Drive from Srinagar to Jammu via scenic Banihal Pass. Enroute stop at Vaishno Devi (optional). Overnight stay in Jammu."
      },
      {
        day: "Day 7",
        title: "Departure",
        details: "After breakfast, transfer to Jammu Airport/Railway Station. Tour concludes."
      }
    ]
  },
  {
    ...
    itinerary: [
      {
        ...
        details: "Arrive at Mathura. Check-in at hotel. Visit Krishna Janmabhoomi (birthplace of Lord Krishna), Dwarkadhish Temple, Vishram Ghat (evening aarti on Yamuna river). Overnight stay."
      },
      {
        day: "Day 2",
        title: "Vrindavan",
        details: "Full day in Vrindavan (land of Lord Krishna). Visit ISKCON Temple (world-famous, grand architecture), Banke Bihari Temple, Prem Mandir (illuminated at night), Govardhan Hill (parikrama route). Overnight stay."
      },
      {
        day: "Day 3",
        title: "Barsana → Departure",
        details: "Morning visit to Barsana, birthplace of Radha Rani. Visit Radha Rani Temple (hilltop temple). Return to Mathura. Tour ends with divine blessings."
      }
    ]
  }
];
...
const SERVICES = [
  {
    ...
    details: "We help you book domestic and international flights at competitive rates. Our team searches multiple airlines to find you the best price and schedule. From Bagdogra to any destination — we handle everything."
  },
  {
    id: "hotels",
    icon: Hotel,
    ...
    details: "From budget guesthouses to luxury resorts, we book accommodations across all our tour destinations. We ensure comfortable, clean, and well-located stays for every budget and preference."
  },
  {
    id: "packages",
    icon: Package,
    ...
    details: "Can't find a package that fits? We create fully customized group and private tour packages to match your schedule, budget, and preferences. Tell us where you want to go and we'll design your perfect trip."
  },
  {
    id: "insurance",
    icon: Shield,
    ...
    details: "We assist with travel insurance for both international and domestic tours. Travel with peace of mind knowing you're covered for medical emergencies, trip cancellations, and lost baggage."
  }
];
const TAXI_ROUTES = [
  {
...
function HeroTagline() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-10 h-8 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "p",
    {
...
function App() {
  ...
  const [expandedPackage, setExpandedPackage] = reactExports.useState(null);
  ...
  const [heroSlide, setHeroSlide] = reactExports.useState(0);
  reactExports.useEffect(() => {
  ...
  const handleFormSubmit = (e) => {
    ...
    setFormSent(true);
    setTimeout(() => setFormSent(false), 3e3);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-cream font-body", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Travellers Points – Best Tour Packages from Jaigaon | Bhutan, Darjeeling, Sikkim, Kashmir" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-navy shadow-luxury" : "bg-navy/95"}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-cream font-display text-lg font-bold leading-tight hidden sm:block", children: "Travellers Points" })
                ]
              }
            ),
          ...
          mobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden pb-4 border-t border-navy-light/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2 pt-3", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: link.href,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          ...
          style: {
            background: "linear-gradient(135deg, oklch(0.18 0.09 150) 0%, oklch(0.25 0.09 150) 40%, oklch(0.28 0.10 170) 70%, oklch(0.22 0.09 160) 100%)"
          },
          children: [
            HERO_SLIDES.map((slide, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: slide.src,
                alt: slide.label,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-24 right-6 z-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gold/90 text-white text-sm font-bold px-4 py-1.5 rounded-full shadow-lg backdrop-blur-sm flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3.5 h-3.5" }),
              HERO_SLIDES[heroSlide].label
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-4 max-w-5xl mx-auto pt-24", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-gold/25 border border-gold/40 text-gold px-4 py-1.5 rounded-full text-sm font-medium mb-6 backdrop-blur-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4" }),
                "Based in Jaigaon, West Bengal"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-bold text-white mb-6 leading-tight", children: [
                "Explore the World with",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-gold mt-1", children: "Travellers Points" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/90 text-lg md:text-xl mb-6 max-w-2xl mx-auto", children: "Premium Tour Packages from Jaigaon, West Bengal — crafting extraordinary Himalayan journeys." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(HeroTagline, {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col sm:flex-row gap-4 justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  href: "#packages",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-6 mt-16 max-w-lg mx-auto", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gold font-display text-3xl font-bold", children: stat.value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/80 text-sm mt-1", children: stat.label })
              ] }, stat.label)) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-16 left-1/2 -translate-x-1/2 flex gap-2 z-20", children: HERO_SLIDES.map((slide, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => setHeroSlide(i),
                className: `rounded-full transition-all duration-300 ${i === heroSlide ? "bg-gold w-8 h-3" : "bg-white/50 w-3 h-3 hover:bg-white/80"}`,
                "aria-label": `Go to slide ${slide.label}`,
                "data-ocid": "hero.toggle"
              },
              slide.label
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 text-white/50 animate-bounce", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-6 h-6" }) })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "packages", className: "py-20 bg-cream", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title", children: "Our Tour Packages" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subtitle", children: "Expertly curated packages for unforgettable journeys across the Himalayas" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: PACKAGES.map((pkg, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-navy to-navy-light p-6", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 mb-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-gold text-white text-xs font-semibold border-0", children: pkg.destination }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-gold text-white text-xs font-bold border-0 px-2 py-1", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-3 h-3 mr-1" }),
                        pkg.duration
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-white mb-1", children: pkg.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-xs", children: pkg.highlight })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 flex flex-col flex-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-display font-bold text-navy", children: pkg.price }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-600 text-sm ml-1", children: pkg.priceNote })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500", children: "Pickup" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-medium text-charcoal", children: pkg.pickup })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "View Itinerary" }),
                          expandedPackage === pkg.id ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-4 h-4" })
                        ]
                      }
                    ),
                    expandedPackage === pkg.id && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 space-y-3 max-h-72 overflow-y-auto pr-1", children: pkg.itinerary.map((day) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        className: "border-l-2 border-gold pl-3",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs bg-gold/20 text-gold-dark font-bold px-2 py-0.5 rounded-full", children: day.day }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-charcoal", children: day.title })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-600 leading-relaxed", children: day.details })
                        ]
                      },
                      day.day
                    )) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "taxi", className: "py-20 bg-cream-dark", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title", children: "Local Taxi Services" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subtitle", children: "Reliable transfers from Jaigaon to nearby destinations" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 sm:grid-cols-3", "data-ocid": "taxi.list", children: TAXI_ROUTES.map((route, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "bg-white rounded-2xl shadow-card p-6 text-center card-hover",
            "data-ocid": `taxi.item.${idx + 1}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 bg-navy/10 rounded-full flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { className: "w-7 h-7 text-navy" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-slate-600 mb-1", children: [
                "From ",
                route.from
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display text-xl font-bold text-navy mb-2", children: [
                "→ ",
                route.to
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 text-sm text-slate-600 mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-4 h-4" }),
                " ",
                route.duration
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-600 mb-5", children: route.note }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  href: waLink(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "py-20 bg-cream", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title", children: "Our Services" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subtitle", children: "End-to-end travel solutions for your perfect journey" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: SERVICES.map((svc, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 bg-navy/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-navy group-hover:text-cream transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(svc.icon, { className: "w-7 h-7 text-navy group-hover:text-cream transition-colors" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold text-charcoal mb-2", children: svc.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-600", children: svc.short }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 text-xs font-semibold text-navy flex items-center gap-1", children: [
                    "Click for details",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-3 h-3 rotate-[-90deg]" })
                  ] })
                ]
              },
              svc.id
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Dialog,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "max-w-md", "data-ocid": "services.dialog", children: activeService && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "font-display text-xl flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 bg-navy/10 rounded-lg flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(activeService.icon, { className: "w-5 h-5 text-navy" }) }),
              activeService.title
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-600 text-sm leading-relaxed", children: activeService.details }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "reviews", className: "py-20 bg-navy", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-display font-bold text-white mb-3", children: "Client Reviews" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-lg", children: "What our travellers say about us" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: REVIEWS.map((review, reviewIdx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mb-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 fill-gold text-gold" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 fill-gold text-gold" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 fill-gold text-gold" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 fill-gold text-gold" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 fill-gold text-gold" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/90 text-sm leading-relaxed mb-4", children: [
                    "“",
                    review.text,
                    "”"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-white/20 pt-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-white text-sm", children: review.name }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-20 bg-cream-dark", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title", children: "Contact Us" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subtitle", children: "Get in touch to plan your dream trip" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 lg:grid-cols-2 max-w-5xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold text-navy mb-6", children: "Get in Touch" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 bg-navy/10 rounded-xl flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-5 h-5 text-navy" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-charcoal", children: "Address" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-slate-600 text-sm", children: "Jaigaon, Alipurduar, West Bengal, India" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 bg-navy/10 rounded-xl flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-5 h-5 text-navy" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-charcoal", children: "WhatsApp / Phone" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "a",
                      {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-navy rounded-2xl p-6 text-white", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-lg font-bold mb-2 text-white", children: "Quick WhatsApp Enquiry" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-sm mb-4", children: "For fastest response, message us directly on WhatsApp" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  href: waLink(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "form",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-charcoal", children: "Send a Message" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: formSent ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "data-ocid": "contact.success_state", children: "✓ Message Sent via WhatsApp!" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-charcoal text-white/70", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-8 sm:grid-cols-2 lg:grid-cols-4 mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xl font-bold text-white", children: "Travellers Points" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed mb-4 max-w-xs text-white/70", children: "Premium tour packages from Jaigaon, West Bengal. Bhutan, Darjeeling, Sikkim, Nepal & more." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 text-sm", children: [
            ...
            ["#reviews", "Reviews"],
            ["#contact", "Contact"]
          ].map(([href, label]) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white font-semibold mb-4", children: "Destinations" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 text-sm", children: [
            "Bhutan",
            "Darjeeling",
            "Sikkim",
            ...
            "Kashmir",
            "Mathura"
          ].map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: "#packages",
              className: "hover:text-gold transition-colors",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/60", children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " Travellers Points. All rights reserved."
        ] }),
