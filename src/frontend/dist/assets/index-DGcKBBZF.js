    ...
    itinerary: [
      {
        ...
        details: "Pick-up from Bagdogra Airport (IXB) or New Jalpaiguri (NJP) and drive to Phuentsholing. Check in to the hotel and spend the evening exploring Phuentsholing's monasteries, parks, and nightlife."
      },
      {
        day: "Day 2",
        title: "Journey to Thimphu",
        details: "After breakfast and immigration, drive to Thimphu. Stopovers at Kharbandi Gumpa, Chukha Waterfall, Chukha Dam, and Dharma Kaya Stupas. Evening guided walk around Thimphu's Clock Tower Square."
      },
      {
        day: "Day 3",
        title: "Excursion to Punakha",
        details: "Drive to Punakha with stops at Dochula Pass and the Suspension Bridge. Visit Punakha Dzong and the Two Rivers viewpoint. Optional activities: River rafting and riverside lunch. Return to Thimphu for the night."
      },
      {
        day: "Day 4",
        title: "Thimphu Sightseeing & Drive to Paro",
        details: "Morning sightseeing in Thimphu: Simtokha Dzong, Buddha Dordenma, Tashichho Dzong, Simply Bhutan, and the Takin Preserve Zoo. Drive to Paro, stopping at the historic Tachogang Lhakhang iron chain bridge. Evening free time to explore Paro local market and nightlife."
      },
      {
        day: "Day 5",
        title: "Hike to Tiger's Nest",
        details: "Early morning hike to Taktshang Lhakhang (Tiger's Nest). Stop at the canteen halfway for views and rest. Optional: Relaxing hot stone bath in Paro."
      },
      {
        day: "Day 6",
        title: "Paro Sightseeing & Drive back to Phuentsholing",
        details: "Visit Paro Ta Dzong in the morning. Sightseeing en route while driving back to Phuentsholing. Free evening in Phuentsholing."
      },
      {
        day: "Day 7",
        title: "Departure",
        details: "Drive from Phuentsholing to Bagdogra Airport or New Jalpaiguri (NJP) for your flight home."
      }
    ],
    exclusions: [
      "Air/train tickets",
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        details: "Tiger Hill sunrise (4am), Ghoom Monastery, Batasia Loop, Rock Garden, Mirik Lake."
      },
      {
        day: "Day 3",
        title: "Tea Gardens & Culture",
        details: "Tea Garden visit, Happy Valley Tea Estate, Himalayan Mountaineering Institute, Zoo, Ropeway."
      },
      {
        day: "Day 4",
        title: "Departure",
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        details: "Tsomgo Lake (12,400 ft), Baba Mandir, Nathula Pass (subject to permit)."
      },
      {
        day: "Day 3",
        title: "Gangtok Local Sightseeing",
        details: "Rumtek Monastery, Enchey Monastery, Namgyal Institute of Tibetology, Flower Exhibition Centre."
      },
      {
        day: "Day 4",
...
const SERVICES = [
  {
    ...
    detail: "We assist with domestic and international flight bookings for all your tour destinations. Get best rates for Bagdogra, Kolkata, Delhi, Srinagar, Kathmandu routes. Contact us on WhatsApp for availability and current pricing."
  },
  {
    icon: "🏨",
    name: "Hotels",
    description: "Premium hotel & resort bookings",
    detail: "Premium hotel and resort bookings across all destinations — Bhutan, Darjeeling, Sikkim, Nepal, Manali, Shimla, Kashmir. Handpicked properties ensuring comfort and value for your stay."
  },
  {
    icon: "🗺️",
    name: "Tour Packages",
    description: "Complete customizable tour packages",
    detail: "Complete tour packages with accommodation, meals, transport, and guided sightseeing. All our packages are fully customizable as per your requirements. Group and private options available for all budgets."
  },
  {
    icon: "🛡️",
    name: "Travel Insurance",
    description: "Trip protection & travel insurance",
    detail: "Travel insurance guidance for domestic and international tours. Protect your trip against cancellations, medical emergencies, and travel delays. We help you choose the right coverage for peace of mind."
  },
  {
    icon: "🎫",
    name: "Flight Booking",
    description: "Hassle-free flight ticket booking",
    detail: "Book domestic and international flight tickets with ease. We handle seat selection, check-in assistance, and the best available fares for all routes including Bagdogra (IXB), Kolkata, Delhi, Srinagar, Kathmandu, and more. Get special group fares for tour packages. Contact us on WhatsApp for instant quotes."
  },
  {
    icon: "🚂",
    name: "Tatkal Train Booking",
    description: "Tatkal & regular train ticket booking",
    detail: "We assist with Tatkal and regular IRCTC train ticket bookings. Fast confirmation on Tatkal quota for NJP (New Jalpaiguri), Alipurduar, Kolkata, and other major routes. No more waiting in queues — just WhatsApp us with your travel details for prompt booking assistance."
  }
];
const REVIEWS = [
  {
...
function Navbar({ scrolled }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-orange-600/95 backdrop-blur-md shadow-md border-b border-gold/10" : "bg-white/10 backdrop-blur-sm"}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16 md:h-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg font-semibold text-orange-500 hidden sm:block", children: "Traveller Point" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-8", children: [
            links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                href: l.href,
                className: `nav-link text-sm font-body font-medium tracking-wide ${scrolled ? "text-gray-800" : "text-white"}`,
                "data-ocid": "nav.link",
                children: l.label
              },
              l.label
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-orange-600 border-t border-gold/10 py-4 shadow-md", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: l.href,
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        HERO_IMAGES.map((src, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-10 bg-gradient-to-b from-black/60 via-black/40 to-black/70" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-20 text-center px-4 max-w-5xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold tracking-[0.3em] text-sm md:text-base mb-4 uppercase", children: "Welcome to" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-5xl md:text-7xl lg:text-8xl text-gold-gradient mb-6 leading-tight", children: [
            "TRAVELLERS",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic font-normal", children: "Points" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider mx-auto mb-6" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl md:text-2xl text-white italic mb-3", children: "From your dream to the world." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/80 text-sm md:text-base tracking-widest mb-10", children: "Expert tours to Bhutan • Darjeeling • Sikkim" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: "#packages",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-8 left-0 right-0 z-20 flex justify-center gap-2", children: HERO_IMAGES.map((src, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => setCurrent(i),
            className: `w-8 h-0.5 transition-all duration-300 ${i === current ? "bg-gold" : "bg-white/30"}`,
...
function PackageCard({ pkg, index: index2 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-40 h-40 rounded-xl overflow-hidden border-4 border-gold/30 shadow-lg mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: pkg.image,
            alt: pkg.name,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg text-gold font-semibold mb-1", children: pkg.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-500 text-sm mb-2", children: pkg.duration }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 justify-center mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold text-xs", children: "📍" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-gray-500 text-xs", children: pkg.pickup })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold text-xs italic mb-4", children: "Customized package available on request" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            "data-ocid": `packages.toggle.${index2 + 1}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: open ? "Hide Itinerary" : "View Itinerary" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full text-left mt-4 space-y-3 border-t border-gold/10 pt-4", children: [
          pkg.itinerary.map((day) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block bg-gold text-white text-xs font-body font-semibold px-2 py-0.5 rounded-sm", children: day.day }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white text-sm font-medium", children: day.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/80 text-xs mt-0.5 leading-relaxed", children: day.details })
            ] })
          ] }, day.day)),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 p-3 bg-orange-700 rounded-sm border border-orange-500", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold text-xs font-semibold uppercase tracking-wider mb-2", children: "Inclusions" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: pkg.inclusions.map((inc) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
          ...
          pkg.exclusions && pkg.exclusions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 p-3 bg-orange-700 rounded-sm border border-orange-500", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-red-500 text-xs font-semibold uppercase tracking-wider mb-2", children: "Exclusions" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: pkg.exclusions.map((exc) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
                className: "font-body text-white/80 text-xs flex items-center gap-1.5",
                children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              "data-ocid": `packages.primary_button.${index2 + 1}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "svg",
                  {
...
function AboutSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20", style: { background: "#f97316" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-12 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
          ...
          style: { color: "#d97706" },
          children: "About Traveller Point"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white mb-4 text-base leading-relaxed", children: "Traveller Point is a premier travel agency based in Jaigaon, Alipurduar, West Bengal — your gateway to the enchanting kingdoms of Bhutan, the misty hills of Darjeeling, the scenic valleys of Sikkim, and beyond." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white mb-4 text-base leading-relaxed", children: "With years of experience in organising memorable tours, we specialise in customised group and private packages to Bhutan, Darjeeling, Sikkim, Nepal, Kashmir, Manali, and Shimla. Our expert team ensures every journey is seamless — from pickup at NJP/Bagdogra to your final destination." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white mb-6 text-base leading-relaxed", children: "We are committed to giving every traveller the best experience at the most affordable rates, with round-the-clock WhatsApp support." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-white mb-6 italic text-lg", children: '"From your dream to the world."' }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
...
const BHUTAN_SUB_PACKAGES = [
    ...
    itinerary: [
      {
        ...
        details: "Pick-up from Bagdogra Airport or NJP. Check-in and explore Phuentsholing."
      },
      {
        day: "Day 2",
        title: "Drive to Thimphu",
        details: "Immigration, drive to Thimphu via Kharbandi Gumpa, Chukha Dam. Evening at Clock Tower Square."
      },
      {
        day: "Day 3",
        title: "Thimphu & Drive to Paro",
        details: "Buddha Dordenma, Tashichho Dzong, Simply Bhutan. Drive to Paro via iron chain bridge."
      },
      {
        day: "Day 4",
        title: "Tiger's Nest Hike",
        details: "Early morning hike to Taktshang Lhakhang (Tiger's Nest). Optional hot stone bath."
      },
      {
        day: "Day 5",
        title: "Departure",
        details: "Drive back to Phuentsholing and then to Bagdogra Airport or NJP."
      }
    ]
  },
  {
    ...
    duration: "5 Nights / 6 Days",
    price: "Contact for pricing",
    summary: "Phuentsholing → Thimphu → Punakha excursion → Paro → Tiger's Nest → Departure",
    itinerary: [
      {
        day: "Day 1",
        title: "Arrival at Phuentsholing",
      ...
      },
      {
        day: "Day 2",
        title: "Drive to Thimphu",
        details: "Immigration, drive to Thimphu via Kharbandi Gumpa, Chukha Waterfall."
      },
      {
        day: "Day 3",
        title: "Punakha Excursion",
        details: "Dochula Pass, Punakha Dzong, Two Rivers viewpoint. Return to Thimphu."
      },
      {
        day: "Day 4",
        title: "Thimphu & Drive to Paro",
        details: "Simtokha Dzong, Buddha Dordenma, Tashichho Dzong. Drive to Paro."
      },
      {
        day: "Day 5",
        title: "Tiger's Nest Hike",
  ...
  },
  {
    ...
    price: "₹24,500/person",
    summary: "Full group tour: Phuentsholing → Thimphu → Punakha → Paro → Tiger's Nest → Departure",
    itinerary: [
      {
        day: "Day 1",
        title: "Arrival and Phuentsholing",
        details: "Pick-up from Bagdogra Airport (IXB) or NJP and drive to Phuentsholing. Check in and explore monasteries, parks, and nightlife."
      },
      {
        day: "Day 2",
        title: "Journey to Thimphu",
        details: "After breakfast and immigration, drive to Thimphu. Stopovers at Kharbandi Gumpa, Chukha Waterfall, Chukha Dam, and Dharma Kaya Stupas. Evening guided walk around Clock Tower Square."
      },
      {
        day: "Day 3",
        title: "Excursion to Punakha",
        details: "Drive to Punakha with stops at Dochula Pass and Suspension Bridge. Visit Punakha Dzong and Two Rivers viewpoint. Optional river rafting and riverside lunch."
      },
      {
        day: "Day 4",
        title: "Thimphu Sightseeing & Drive to Paro",
        details: "Morning sightseeing: Simtokha Dzong, Buddha Dordenma, Tashichho Dzong, Simply Bhutan, Takin Preserve Zoo. Drive to Paro stopping at Tachogang Lhakhang iron chain bridge."
      },
      {
        day: "Day 5",
        title: "Hike to Tiger's Nest",
        details: "Early morning hike to Taktshang Lhakhang (Tiger's Nest). Stop at canteen halfway for views and rest. Optional relaxing hot stone bath in Paro."
      },
      {
        day: "Day 6",
        title: "Paro Sightseeing & Drive to Phuentsholing",
        details: "Visit Paro Ta Dzong in the morning. Sightseeing en route while driving back to Phuentsholing."
      },
      {
        day: "Day 7",
        title: "Departure",
        details: "Drive from Phuentsholing to Bagdogra Airport or NJP for your flight home."
      }
    ]
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        day: "Day 2",
        title: "Drive to Thimphu",
        details: "Immigration, drive to Thimphu via Kharbandi Gumpa, Chukha Waterfall, Chukha Dam."
      },
      {
        day: "Day 3",
        title: "Punakha Excursion",
      ...
      },
      {
        ...
        details: "Simtokha Dzong, Buddha Dordenma, Tashichho Dzong, Simply Bhutan, Takin Preserve Zoo."
      },
      {
        day: "Day 5",
        title: "Drive to Paro & Haa Valley",
        details: "Drive to Paro via iron chain bridge. Afternoon excursion to scenic Haa Valley."
      },
      {
        day: "Day 6",
        title: "Tiger's Nest Hike",
      ...
      },
      {
        ...
        details: "Visit Paro Ta Dzong, Rinpung Dzong, and local market. Drive back to Phuentsholing."
      },
      {
        day: "Day 8",
        title: "Departure",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg text-gold font-semibold mb-1", children: "Bhutan Tour Packages" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-500 text-sm mb-2", children: "4N/5D · 5N/6D · 6N/7D · 7N/8D" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 justify-center mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold text-xs", children: "📍" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-gray-500 text-xs", children: "Bagdogra Airport or NJP Railway Station" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold text-xs italic mb-4", children: "Customized package available on request" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full py-2 px-3 border border-gold/30 text-gold text-sm font-body text-center rounded-lg hover:bg-gold/10 transition-colors", children: "View All Bhutan Packages ▶" })
        ]
      }
    ),
      ...
      DialogContent,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display text-2xl text-gold", children: "Bhutan Tour Packages" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-600 text-sm", children: "Choose your perfect Bhutan experience" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4 mt-2", children: BHUTAN_SUB_PACKAGES.map((pkg) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-gold font-semibold", children: pkg.duration }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-500 text-xs mt-0.5", children: pkg.summary })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 shrink-0 ml-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-orange-700 text-sm font-semibold", children: pkg.price }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                ...
                expanded === pkg.id && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-4 bg-orange-700 border-t border-gold/20", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 mt-3", children: pkg.itinerary.map((day) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-gold text-xs font-semibold shrink-0 w-12", children: day.day }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white text-sm font-medium", children: day.title }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/80 text-xs mt-0.5 leading-relaxed", children: day.details })
                    ] })
                  ] }, day.day)) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 pt-3 border-t border-gold/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      href: waLink(
...
function PackagesSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "packages", className: "py-20 bg-orange-6000", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold tracking-[0.25em] text-sm uppercase mb-3", children: "Explore" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl text-white mb-4", children: "Our Tour Packages" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(BhutanTourCard, {}),
      PACKAGES.map((pkg, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(PackageCard, { pkg, index: i }, pkg.id))
    ] })
  ] }) });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        "data-ocid": `services.open_modal_button.${index2 + 1}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-5xl block mb-4", children: service.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl text-gold mb-2", children: service.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/80 text-sm", children: service.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block mt-4 text-xs font-body text-gold/60 group-hover:text-gold transition-colors", children: "Click for details →" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: setOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      DialogContent,
      {
        ...
        "data-ocid": `services.dialog.${index2 + 1}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "font-display text-2xl text-gold flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: service.icon }),
            " ",
            service.name
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/80 leading-relaxed text-sm", children: service.detail }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mt-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                style: { backgroundColor: "#25D366" },
                "data-ocid": `services.primary_button.${index2 + 1}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "svg",
                    {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                "data-ocid": `services.close_button.${index2 + 1}`,
                children: "Close"
              }
            )
          ] })
...
function ServicesSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "py-20", style: { background: "#f97316" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold tracking-[0.25em] text-sm uppercase mb-3", children: "What We Offer" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl text-white mb-4", children: "Our Services" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: SERVICES.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ServiceCard, { service: s, index: i }, s.name)) })
  ] }) });
}
function GallerySection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "gallery", className: "py-20", style: { background: "#f97316" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold tracking-[0.25em] text-sm uppercase mb-3", children: "Our Trips" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl text-white mb-4", children: "Happy Travellers" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-600 mt-4 max-w-xl mx-auto", children: "Real moments, real smiles — our travellers exploring Bhutan with Traveller Point." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-sm shadow-lg border border-gold/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-orange-600", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-gray-900 text-lg", children: "Tiger's Nest, Bhutan" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-500 text-sm mt-1", children: "Happy travellers at Taktshang Lhakhang" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-sm shadow-lg border border-gold/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-orange-600", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-gray-900 text-lg", children: "Bhutan Gate, Jaigaon" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-500 text-sm mt-1", children: "Travellers Point Bhutan Group Tour 2024" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-sm shadow-lg border border-gold/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-orange-600", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-gray-900 text-lg", children: "Punakha Dzong, Bhutan" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-500 text-sm mt-1", children: "Traveller Point group tour at Punakha" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-sm shadow-lg border border-gold/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-orange-600", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-gray-900 text-lg", children: "Rise of Group Tour" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-500 text-sm mt-1", children: "Join Traveller Point group tours to Bhutan" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-sm shadow-lg border border-gold/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-orange-600", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-gray-900 text-lg", children: "Punakha, Bhutan" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-500 text-sm mt-1", children: "Travellers Point Jaigaon group in Bhutan" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-sm shadow-lg border border-gold/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-orange-600", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-gray-900 text-lg", children: "Tiger's Nest Trek, Bhutan" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-500 text-sm mt-1", children: "Travellers Point group trekking to Tiger's Nest" })
        ] })
      ] })
    ] })
  ] }) });
...
function ReviewsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "reviews", className: "py-20", style: { background: "#f97316" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold tracking-[0.25em] text-sm uppercase mb-3", children: "Testimonials" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl text-white mb-4", children: "What Our Travellers Say" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: REVIEWS.map((review, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 mb-4", children: ["1", "2", "3", "4", "5"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold text-sm", children: "★" }, s)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-gray-600 text-sm leading-relaxed italic mb-5", children: [
            "“",
            review.text,
            "”"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 pt-4 border-t border-gold/10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-gold/20 border border-gold/30 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-gold text-sm font-semibold", children: review.author.charAt(0) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white text-sm font-medium", children: review.author }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-600 text-xs", children: review.location })
            ] })
          ] })
        ]
      },
...
function ContactSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", style: { background: "#f97316" }, className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold tracking-[0.25em] text-sm uppercase mb-3", children: "Get In Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl text-white mb-4", children: "Contact Us" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-600 mt-4 text-sm", children: "Contact us to plan your dream tour" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl text-orange-500 mb-6", children: "Traveller Point" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-600 text-sm leading-relaxed", children: "Your trusted travel partner for unforgettable journeys to Bhutan, Darjeeling, and Sikkim. From your dream to the world." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gold text-xs font-semibold uppercase tracking-wider", children: item.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-gray-900 text-sm mt-0.5", children: item.value })
          ] })
        ] }, item.label)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-10 mb-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg text-orange-500", children: "Traveller Point" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-cream-dark text-sm italic", children: "From your dream to the world." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark/90 text-xs mt-3 leading-relaxed", children: "Expert travel agency specializing in tours to Bhutan, Darjeeling, and Sikkim." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-body text-gold text-xs uppercase tracking-wider font-semibold mb-4", children: "Quick Links" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-body text-gold text-xs uppercase tracking-wider font-semibold mb-4", children: "Contact" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("address", { className: "not-italic space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark text-sm", children: "Jaigaon, Alipurduar" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark text-sm", children: "West Bengal, India" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark text-sm mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: "tel:7719264029",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-cream-dark text-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: WA_BASE,
                  target: "_blank",
                  rel: "noopener noreferrer",
                  className: "hover:text-gold transition-colors",
                  children: "💬 WhatsApp: 7719264029"
                }
              ) })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-gold/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-cream-dark/80 text-xs", children: [
          "© ",
          year,
          " Traveller Point. All rights reserved."
        ] }) })
      ] })
    }
  );
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", style: { background: "#f97316" }, children: [
...
Service({
  "getAllSubmissions": Func([], [Vec(ContactSubmission)], ["query"]),
